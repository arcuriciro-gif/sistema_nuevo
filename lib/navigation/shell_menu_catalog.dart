...
const List<ShellMenuEntry> kShellMenuCatalog = [
  ...
  ShellMenuEntry(id: 'remitos|Entregas (sin factura)', title: 'Entregas (sin factura)', icon: Icons.local_shipping_outlined),
  ShellMenuEntry(id: 'remitos|Tickets internos', title: 'Tickets internos', icon: Icons.article_outlined),
