...
class PlantillaImportacionService {
  ...
  Future<File> generarPlantillaProductos() => _generarExcel(
        ...
        instrucciones: const [
          ...
          '',
          'PRECIOS AUTOMÁTICOS:',
          'Si cargás Costo y dejás Precio1/2/3 vacíos, el sistema los calcula',
          'con el % de cada Lista de precios (costo x (1 + % / 100)).',
          'Si ponés un precio en la celda, se respeta ese valor.',
          '',
