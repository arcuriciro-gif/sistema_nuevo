...
Versión actual: **`1.2.0+23`**  
En la pantalla de **login** debe verse abajo: **`Tata.Manager v1.2.0 (23)`**.  
...
3. En login verificá **`v1.2.0 (23)`**. Si no está, no es este build.
...
3. Login → debe decir **`Tata.Manager v1.2.0 (23)`**.
...
4. Abrí y verificá login: **`v1.2.0 (23)`**.
