...
Versión actual: **`1.1.9+19`**  
En la pantalla de **login** debe verse abajo: **`Tata.Manager v1.1.9 (19)`**.  
...
3. En login verificá **`v1.1.9 (19)`**. Si no está, no es este build.
...
3. Login → debe decir **`Tata.Manager v1.1.9 (19)`**.
...
4. Abrí y verificá login: **`v1.1.9 (19)`**.
